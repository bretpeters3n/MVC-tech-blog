...
<h1 align="center">MVC Tech Blog</h1>
  ...
  <p align="center">
    This project required making a tech blog.
    <br />
    <br />
...
<!-- OVERVIEW -->
## Overview
This project required making a tech blog where a user can sign up, login, create posts, and comment on posts. The user can also delete their posts and comments. There is a dashboard the user can access to see posts of their own.

This project is currently incomplete. Feel free to install it, but expect to see errors:/
...
1. Clone the repo
   ```sh
   git clone https://github.com/bretpeters3n/MVC-tech-blog.git
   ```
...
<!-- QUESTIONS -->
## Contact
Need a contact or have questions about this project? Please review the GitHub repo at [MVC Tech Blog](https://github.com/bretpeters3n/MVC-tech-blog) or contact one of the authors on Github.
